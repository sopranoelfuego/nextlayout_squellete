// import { unstable_composeClasses as composeClasses, createFilterOptions } from "@mui/base";
...
// import autocompleteClasses, { getAutocompleteUtilityClass } from "@mui/material/Autocomplete/autocompleteClasses";
...
// import useAutocomplete from "./useCustomAutoComplete";

// const useUtilityClasses = (ownerState) => {
//     const { classes, disablePortal, focused, fullWidth, hasClearIcon, hasPopupIcon, inputFocused, popupOpen, size } = ownerState;
...
//                 <Chip label={getOptionLabel(option)} size={size} {...getCustomizedTagProps({ index })} {...ChipProps} key={index} />
//             ));
//         }
//     }
...
//     return (
//         <>
//             <AutocompleteRoot ref={ref} className={clsx(classes.root, className)} ownerState={ownerState} {...getRootProps(other)}>
//                 {renderInput({
//                     id,
//                     disabled,
//                     fullWidth: true,
