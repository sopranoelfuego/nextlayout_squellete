                ...
                <CustomChip
                  ...
                  text={`${
                    resumee.CreditResponse.filter(
                      (c: ICreditType) => c.status === "IN_PAYMENT"
                    ).length
                  } - ${intl.formatMessage({ id: "IN_PAYMENT" })}`}
                />
                <CustomChip
                  color="#055E68"
                  text={` ${
                    resumee.CreditResponse.filter(
                      (c: ICreditType) => c.status === "IN_TREATMENT"
                    ).length
                  } - ${intl.formatMessage({ id: "IN_TREATMENT" })}`}
                />
                <CustomChip
                  color="#82472b"
                  text={` ${
                    resumee.CreditResponse.filter(
                      (c: ICreditType) => c.status === "PAID"
                    ).length
