        ...
        >
          ...
          >
            ...
            <Box sx={{ width: "100%" }}>
              ...
              >
                <Link href={"/timeline"} className="text-left text-sm ">
                  <FormattedMessage id="noaccount" />
                </Link>
                <button className="w-fit rounded-md  bg-mainColor whitespace-nowrap text-white py font-bold px-9 hover:bg-inherit border border-md border-mainColor  transition-all duration-500 hover:text-mainColor ">
